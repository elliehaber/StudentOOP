...
$(TEST_DIR)/test_weather: $(STUDENT_DIR)/weather.cpp $(TEST_DIR)/test_weather.cpp $(STUDENT_DIR)/date.cpp
...
tests: test_hello test_basics test_pointers test_weather test_complex test_vector test_llist
	tests/test_basics
	tests/test_pointers
	tests/test_weather
	tests/test_complex
